...
- **You can create transactions using this website**
- **You can count total transactions**
...
```sh
  cd my-folder
  git clone https://github.com/matee-safi/rails-budget-app.git
```
...
- **Make sure to follow our socials for future updates**
